...
public class P4ActionCaseImpl extends ASTWrapperPsiElement implements P4ActionCase {

  public P4ActionCaseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitActionCase(this);
  }
  ...
  @Override
  @NotNull
  public P4ActionOrDefault getActionOrDefault() {
    return findNotNullChildByClass(P4ActionOrDefault.class);
  }
