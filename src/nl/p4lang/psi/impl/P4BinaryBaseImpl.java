...
public class P4BinaryBaseImpl extends ASTWrapperPsiElement implements P4BinaryBase {

  public P4BinaryBaseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitBinaryBase(this);
  }
