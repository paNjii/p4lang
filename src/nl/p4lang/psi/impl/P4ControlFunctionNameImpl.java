...
public class P4ControlFunctionNameImpl extends ASTWrapperPsiElement implements P4ControlFunctionName {

  public P4ControlFunctionNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitControlFunctionName(this);
  }
