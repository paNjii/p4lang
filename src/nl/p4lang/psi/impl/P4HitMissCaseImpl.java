...
public class P4HitMissCaseImpl extends ASTWrapperPsiElement implements P4HitMissCase {

  public P4HitMissCaseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitHitMissCase(this);
  }
  ...
  @Override
  @NotNull
  public P4HitOrMiss getHitOrMiss() {
    return findNotNullChildByClass(P4HitOrMiss.class);
  }
