...
public class P4ParserStateNameImpl extends ASTWrapperPsiElement implements P4ParserStateName {

  public P4ParserStateNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitParserStateName(this);
  }
