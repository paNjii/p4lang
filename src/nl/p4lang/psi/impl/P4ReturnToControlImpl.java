...
public class P4ReturnToControlImpl extends ASTWrapperPsiElement implements P4ReturnToControl {

  public P4ReturnToControlImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitReturnToControl(this);
  }
