...
public class P4BinaryDigitImpl extends ASTWrapperPsiElement implements P4BinaryDigit {

  public P4BinaryDigitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitBinaryDigit(this);
  }
