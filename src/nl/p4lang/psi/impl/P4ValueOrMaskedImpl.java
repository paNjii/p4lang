...
public class P4ValueOrMaskedImpl extends ASTWrapperPsiElement implements P4ValueOrMasked {

  public P4ValueOrMaskedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitValueOrMasked(this);
  }
