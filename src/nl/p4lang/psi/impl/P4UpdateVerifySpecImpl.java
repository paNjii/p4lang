...
public class P4UpdateVerifySpecImpl extends ASTWrapperPsiElement implements P4UpdateVerifySpec {

  public P4UpdateVerifySpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitUpdateVerifySpec(this);
  }
  ...
  @Override
  @NotNull
  public P4UpdateOrVerify getUpdateOrVerify() {
    return findNotNullChildByClass(P4UpdateOrVerify.class);
  }
