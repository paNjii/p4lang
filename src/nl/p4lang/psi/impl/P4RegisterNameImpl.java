...
public class P4RegisterNameImpl extends ASTWrapperPsiElement implements P4RegisterName {

  public P4RegisterNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitRegisterName(this);
  }
