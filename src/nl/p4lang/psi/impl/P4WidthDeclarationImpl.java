...
public class P4WidthDeclarationImpl extends ASTWrapperPsiElement implements P4WidthDeclaration {

  public P4WidthDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitWidthDeclaration(this);
  }
