...
public class P4FieldMatchImpl extends ASTWrapperPsiElement implements P4FieldMatch {

  public P4FieldMatchImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitFieldMatch(this);
  }
