...
public class P4ApplyTableCallImpl extends ASTWrapperPsiElement implements P4ApplyTableCall {

  public P4ApplyTableCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitApplyTableCall(this);
  }
