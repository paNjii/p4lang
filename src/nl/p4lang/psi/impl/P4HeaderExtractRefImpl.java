...
public class P4HeaderExtractRefImpl extends ASTWrapperPsiElement implements P4HeaderExtractRef {

  public P4HeaderExtractRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitHeaderExtractRef(this);
  }
  ...
  @Override
  @Nullable
  public P4HeaderExtractIndex getHeaderExtractIndex() {
