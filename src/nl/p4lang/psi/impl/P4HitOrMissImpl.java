...
public class P4HitOrMissImpl extends ASTWrapperPsiElement implements P4HitOrMiss {

  public P4HitOrMissImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitHitOrMiss(this);
  }
