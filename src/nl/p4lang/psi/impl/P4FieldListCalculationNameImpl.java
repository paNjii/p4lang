...
public class P4FieldListCalculationNameImpl extends ASTWrapperPsiElement implements P4FieldListCalculationName {

  public P4FieldListCalculationNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitFieldListCalculationName(this);
  }
