...
public class P4UpdateOrVerifyImpl extends ASTWrapperPsiElement implements P4UpdateOrVerify {

  public P4UpdateOrVerifyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitUpdateOrVerify(this);
  }
