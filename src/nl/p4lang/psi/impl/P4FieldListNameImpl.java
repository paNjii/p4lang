...
public class P4FieldListNameImpl extends ASTWrapperPsiElement implements P4FieldListName {

  public P4FieldListNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitFieldListName(this);
  }
