...
public class P4ElseBlockImpl extends ASTWrapperPsiElement implements P4ElseBlock {

  public P4ElseBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public P4ControlBlock getControlBlock() {
    return findChildByClass(P4ControlBlock.class);
  }
