...
public class P4StreamFunctionAlgorithmNameImpl extends ASTWrapperPsiElement implements P4StreamFunctionAlgorithmName {

  public P4StreamFunctionAlgorithmNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitStreamFunctionAlgorithmName(this);
  }
