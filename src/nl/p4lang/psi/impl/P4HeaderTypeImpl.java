...
public class P4HeaderTypeImpl extends ASTWrapperPsiElement implements P4HeaderType {

  public P4HeaderTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitHeaderType(this);
  }
