...
public class P4ReturnValueTypeImpl extends ASTWrapperPsiElement implements P4ReturnValueType {

  public P4ReturnValueTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitReturnValueType(this);
  }
