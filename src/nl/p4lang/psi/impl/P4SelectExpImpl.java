...
public class P4SelectExpImpl extends ASTWrapperPsiElement implements P4SelectExp {

  public P4SelectExpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitSelectExp(this);
  }
