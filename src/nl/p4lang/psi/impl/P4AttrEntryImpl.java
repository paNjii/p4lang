...
public class P4AttrEntryImpl extends ASTWrapperPsiElement implements P4AttrEntry {

  public P4AttrEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitAttrEntry(this);
  }
