...
public class P4MeterTypeImpl extends ASTWrapperPsiElement implements P4MeterType {

  public P4MeterTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitMeterType(this);
  }
