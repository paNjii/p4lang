...
public class P4CounterTypeImpl extends ASTWrapperPsiElement implements P4CounterType {

  public P4CounterTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitCounterType(this);
  }
