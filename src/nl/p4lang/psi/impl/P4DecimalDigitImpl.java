...
public class P4DecimalDigitImpl extends ASTWrapperPsiElement implements P4DecimalDigit {

  public P4DecimalDigitImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public P4BinaryDigit getBinaryDigit() {
    return findChildByClass(P4BinaryDigit.class);
  }
