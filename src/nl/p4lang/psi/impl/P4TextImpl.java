...
public class P4TextImpl extends ASTWrapperPsiElement implements P4Text {

  public P4TextImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public P4Letter getLetter() {
    return findNotNullChildByClass(P4Letter.class);
  }
