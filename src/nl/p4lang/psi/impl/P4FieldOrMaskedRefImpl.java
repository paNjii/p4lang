...
public class P4FieldOrMaskedRefImpl extends ASTWrapperPsiElement implements P4FieldOrMaskedRef {

  public P4FieldOrMaskedRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitFieldOrMaskedRef(this);
  }
