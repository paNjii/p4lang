...
public class P4SelectorNameImpl extends ASTWrapperPsiElement implements P4SelectorName {

  public P4SelectorNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitSelectorName(this);
  }
