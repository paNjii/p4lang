...
public class P4MetadataExprImpl extends ASTWrapperPsiElement implements P4MetadataExpr {

  public P4MetadataExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitMetadataExpr(this);
  }
  ...
  public P4FieldOrDataRef getFieldOrDataRef() {
    return findChildByClass(P4FieldOrDataRef.class);
  }
