...
public class P4ActionSelectorDeclarationImpl extends ASTWrapperPsiElement implements P4ActionSelectorDeclaration {

  public P4ActionSelectorDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitActionSelectorDeclaration(this);
  }
