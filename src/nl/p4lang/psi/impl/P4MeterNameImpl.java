...
public class P4MeterNameImpl extends ASTWrapperPsiElement implements P4MeterName {

  public P4MeterNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitMeterName(this);
  }
