...
public class P4DirectAttributeImpl extends ASTWrapperPsiElement implements P4DirectAttribute {

  public P4DirectAttributeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitDirectAttribute(this);
  }
