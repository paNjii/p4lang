...
public class P4ParserExceptionNameImpl extends ASTWrapperPsiElement implements P4ParserExceptionName {

  public P4ParserExceptionNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitParserExceptionName(this);
  }
