...
public class P4HeaderExtractIndexImpl extends ASTWrapperPsiElement implements P4HeaderExtractIndex {

  public P4HeaderExtractIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitHeaderExtractIndex(this);
  }
