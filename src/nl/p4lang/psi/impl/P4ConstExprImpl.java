...
public class P4ConstExprImpl extends ASTWrapperPsiElement implements P4ConstExpr {

  public P4ConstExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public P4DecimalDigit getDecimalDigit() {
    return findNotNullChildByClass(P4DecimalDigit.class);
  }
