...
public class P4InstanceNameImpl extends ASTWrapperPsiElement implements P4InstanceName {

  public P4InstanceNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitInstanceName(this);
  }
