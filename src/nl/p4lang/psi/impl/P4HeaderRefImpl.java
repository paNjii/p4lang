...
public class P4HeaderRefImpl extends ASTWrapperPsiElement implements P4HeaderRef {

  public P4HeaderRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitHeaderRef(this);
  }
