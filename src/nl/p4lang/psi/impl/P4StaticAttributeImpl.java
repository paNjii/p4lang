...
public class P4StaticAttributeImpl extends ASTWrapperPsiElement implements P4StaticAttribute {

  public P4StaticAttributeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitStaticAttribute(this);
  }
