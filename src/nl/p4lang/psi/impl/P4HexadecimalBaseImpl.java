...
public class P4HexadecimalBaseImpl extends ASTWrapperPsiElement implements P4HexadecimalBase {

  public P4HexadecimalBaseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitHexadecimalBase(this);
  }
