...
public class P4RegisterDeclarationImpl extends ASTWrapperPsiElement implements P4RegisterDeclaration {

  public P4RegisterDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitRegisterDeclaration(this);
  }
  ...
  @Override
  @NotNull
  public P4RegisterName getRegisterName() {
    return findNotNullChildByClass(P4RegisterName.class);
  }
