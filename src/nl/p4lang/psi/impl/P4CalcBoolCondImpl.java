...
public class P4CalcBoolCondImpl extends ASTWrapperPsiElement implements P4CalcBoolCond {

  public P4CalcBoolCondImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitCalcBoolCond(this);
  }
