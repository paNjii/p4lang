...
public class P4ActionOrDefaultImpl extends ASTWrapperPsiElement implements P4ActionOrDefault {

  public P4ActionOrDefaultImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitActionOrDefault(this);
  }
