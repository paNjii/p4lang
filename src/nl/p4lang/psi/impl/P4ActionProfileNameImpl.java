...
public class P4ActionProfileNameImpl extends ASTWrapperPsiElement implements P4ActionProfileName {

  public P4ActionProfileNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitActionProfileName(this);
  }
