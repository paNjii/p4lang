...
public class P4CounterNameImpl extends ASTWrapperPsiElement implements P4CounterName {

  public P4CounterNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitCounterName(this);
  }
