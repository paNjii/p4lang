...
public class P4IfCondImpl extends ASTWrapperPsiElement implements P4IfCond {

  public P4IfCondImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public P4CalcBoolCond getCalcBoolCond() {
    return findNotNullChildByClass(P4CalcBoolCond.class);
  }
