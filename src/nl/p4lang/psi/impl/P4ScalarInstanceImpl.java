...
public class P4ScalarInstanceImpl extends ASTWrapperPsiElement implements P4ScalarInstance {

  public P4ScalarInstanceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitScalarInstance(this);
  }
