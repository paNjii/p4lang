...
public class P4LengthBinOpImpl extends ASTWrapperPsiElement implements P4LengthBinOp {

  public P4LengthBinOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitLengthBinOp(this);
  }
