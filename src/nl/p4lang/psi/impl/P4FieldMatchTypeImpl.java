...
public class P4FieldMatchTypeImpl extends ASTWrapperPsiElement implements P4FieldMatchType {

  public P4FieldMatchTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull P4Visitor visitor) {
    visitor.visitFieldMatchType(this);
  }
