...
public class P4IfElseStatementImpl extends ASTWrapperPsiElement implements P4IfElseStatement {

  public P4IfElseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public P4BoolExpr getBoolExpr() {
    return findNotNullChildByClass(P4BoolExpr.class);
  }
  ...
  @Override
  @Nullable
  public P4ElseBlock getElseBlock() {
    return findChildByClass(P4ElseBlock.class);
  }
